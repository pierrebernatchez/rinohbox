...
pnameit $(codeblockify mkdir -p ${REPOBASE}/${SOMENAME})
pnameit $(codeblockify cd ${REPOBASE}/${SOMENAME})
...
pnameit $(inform "-------------------------------------" )
pnameit $(emphasize  Begin maintaining the project content as and when required)
